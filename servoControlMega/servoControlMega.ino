...
//      Serial.println(pos);
   ...
   // etc...
       ...
       Serial1.print(digitalRead(valve1));
        Serial1.print("\t");                 //send a "tab" over serial
        Serial1.print(digitalRead(valve2));
        Serial1.print("\t");                 //send a "tab" over serial
        Serial1.print(digitalRead(valve3));
        Serial1.println("\n");                   //ends the line of serial communication
